      ...
      >
        ...
        >
          {({ data: { lectures: dataLectures, sections } }) => {
            ...
            const LastSectionDateTime = SectionDateTime
              ? format(new Date(SectionDateTime), 'dd. MMMM. yyyy')
              : 'No sections yet';

            const LastSectionDistance = SectionDateTime
...
export const MeetingStaticCard = ({
  LastMeeting,
  LastMeetingDistance,
  __typename,
  dataLength,
...
export function AvgAttendanceComponent({
  data,
  avgAttendance,
  growth,
  __typename,
